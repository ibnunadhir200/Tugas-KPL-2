...
if (isset($_POST['signupSubmit'])) {
    ...
    if (!empty($_POST['email'])) {
        ...
        if ($prevUser > 0) {
            ...
            if ($update) {
                $resetPassLink = 'localhost/projectku/nader/resetPassword.php?fp_code=' . $uniqidStr;
                ...
                //additional headers
                // $headers .= 'From: nader@gmail.com' . "\r\n";
                //send email
                // mail('jokiding2@gmail.com', $subject, $mailContent, $headers);
